        ...
        <section className="ptw-section ptw-signature-section">
          ...
          <div className="ptw-signature-grid">
            {[
              ...
              { label: 'Issuer', type: 'issuer', fallback: permit.issuer_details },
              { label: 'Receiver', type: 'receiver', fallback: permit.receiver_details },
              { label: 'Safety Officer', type: 'safety_officer', fallback: null },
              { label: 'Area Manager', type: 'area_manager', fallback: null },
              { label: 'Witness', type: 'witness', fallback: null }
            ].map((entry) => {
              const sig = findSignatureByType(signatureMap, entry.type);
              const signatureImageSrc = sig?.signature_data;
              ...
              return (
                <div key={entry.type} className="ptw-signature-card">
                  ...
                  <div className="ptw-signature-image-container">
                    {signatureImageSrc ? (
                      <img 
                        src={resolveSignatureSrc(signatureImageSrc) || ''} 
                        alt={`${entry.label} signature template`} 
