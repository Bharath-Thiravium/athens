export { default as InductionTrainingList } from './components/InductionTrainingList';
export { default as InductionTrainingView } from './components/InductionTrainingView';
