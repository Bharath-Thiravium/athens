...
import { Form, Input, Button, Upload, Typography, InputNumber, Space, App, Spin, Row, Col, Tooltip } from 'antd';
import { UploadOutlined, EditOutlined, SaveOutlined, InfoCircleOutlined } from '@ant-design/icons';
...
const CompanyDetailsForm: React.FC = () => {
  ...
  return (
    <PageLayout
      ...
      subtitle={isCreating ? 'Set up your company information' : 'Manage your company information and settings'}
      breadcrumbs={[
        { title: 'Settings' },
        { title: 'Company Details' }
      ]}
