...
import { Button, App, Card, Typography, Spin, Tag, Upload, Modal } from 'antd';
import { EnvironmentOutlined, CheckCircleOutlined, ClockCircleOutlined, UploadOutlined } from '@ant-design/icons';
...
const ProjectAttendance: React.FC = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          localStorage.setItem('attendanceDate', currentDate); // Store current date
  ...
  return (
    <PageLayout
      title="Project Site Attendance"
      subtitle="Mark your attendance only when you are physically at the project site"
      breadcrumbs={[
        { title: 'Attendance' }
      ]}
    >
