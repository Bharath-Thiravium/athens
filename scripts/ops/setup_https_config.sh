...
ATHENS_BACKEND_PORT=${ATHENS_BACKEND_PORT:-8001}  # Use env var, default to 8001
...
echo "[5/6] Starting backend on port $ATHENS_BACKEND_PORT..."
cd "$BACKEND_DIR"
source venv/bin/activate

# Export port for startup guard
export ATHENS_BACKEND_PORT=$ATHENS_BACKEND_PORT

# Run startup guard
python startup_guard.py

nohup python manage.py runserver 0.0.0.0:$ATHENS_BACKEND_PORT > /tmp/django.log 2>&1 &
BACKEND_PID=$!
sleep 3
...
echo "Setup Complete!"
echo "=========================================="
echo "Backend PID: $BACKEND_PID (Port: $ATHENS_BACKEND_PORT)"
echo "Frontend PID: $FRONTEND_PID"
echo ""
echo "Verification Commands:"
echo "  Backend:  curl -I http://localhost:$ATHENS_BACKEND_PORT/admin/"
...
echo ""
echo "Port Status:"
netstat -tlnp | grep -E ":(80|443|$ATHENS_BACKEND_PORT|3000)"
echo "=========================================="
