...
import { AudioOutlined, StopOutlined, SoundOutlined, EditOutlined, TranslationOutlined } from '@ant-design/icons';
...
const VoiceTranslator: React.FC = () => {
  ...
  return (
    <PageLayout
      ...
      subtitle="Real-time voice and text translation for multilingual communication"
