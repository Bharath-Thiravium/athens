...
const AdminDetail: React.FC = () => {
  ...
  useEffect(() => {
    if (!contextAdminToApprove && userType === 'masteradmin') {
  ...
  useEffect(() => {
    if (adminToApprove && userType === 'masteradmin') {
  ...
  const isApprovalMode = userType === 'masteradmin' && adminToApprove;
  ...
  if (userType === 'masteradmin' && !adminToApprove && !fetching) {
    return (
