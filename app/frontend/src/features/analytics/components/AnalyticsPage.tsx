...
import { Card, Row, Col, Select, Typography, Statistic, Progress, Tabs } from 'antd';
import { 
...
import { 
  ...
  ExclamationCircleOutlined, CheckCircleOutlined, UserOutlined, BarChartOutlined 
...
const AnalyticsPage: React.FC = () => {
  ...
  return (
    <PageLayout
      ...
      subtitle="Comprehensive data insights and performance metrics"
      ...
      actions={
        <Select value={timeRange} onChange={setTimeRange} size="large" style={{ width: 150 }}>
      ...
      <Tabs 
        ...
        items={[
          ...(usertype === 'masteradmin' ? [{
            key: 'admin',
            label: <span><UserOutlined />Admin Analytics</span>,
            children: <AdminAnalytics />
          }] : []),
          {
            key: 'operational',
            label: <span><SafetyOutlined />Operational Analytics</span>,
            children: (
              <>
                {/* KPI Cards */}
                <Row gutter={[16, 16]}>
