...
import { Form, Input, Button, DatePicker, Select, Typography, App, Row, Col, Card, Spin, Breadcrumb } from 'antd';
import { EnvironmentOutlined, PlusOutlined, HomeOutlined } from '@ant-design/icons';
  ...
  return (
    <div className="space-y-6" style={{ paddingTop: 80 }}>
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        <Title level={3} className="!mb-0 !text-color-text-base">Create New Project</Title>
