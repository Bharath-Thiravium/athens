...
import { Card, Button, Table, Progress, Tag, Space, message, Modal, Form, Select, Input, Upload, Typography } from 'antd';
import { DownloadOutlined, UploadOutlined, DeleteOutlined, PlayCircleOutlined, DatabaseOutlined } from '@ant-design/icons';
...
const SystemBackup: React.FC = () => {
  ...
  return (
    <PageLayout
      title="System Backup"
      subtitle="Create, manage and restore system backups"
