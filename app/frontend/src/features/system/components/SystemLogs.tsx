...
import { Card, Table, Tag, Button, Select, DatePicker, Input, Space, message, Typography } from 'antd';
import { DownloadOutlined, ReloadOutlined, SearchOutlined, FileTextOutlined } from '@ant-design/icons';
...
const SystemLogs: React.FC = () => {
  ...
  return (
    <PageLayout
      title="System Logs"
      subtitle="Monitor and analyze system activity logs"
