...
urlpatterns = [
    ...
    path('api/menu/', include('authentication.menu_urls')),  # Menu endpoints
    path('api/attendance/', include('attendance.urls')),
    # path('', include('authentication.tenant_urls')),  # Tenant management APIs - Disabled due to missing serializer
    # path('', include('authentication.menu_urls')),  # Menu management APIs - Disabled
    ...
    path('api/saas/', include('control_plane.saas_urls')),
    # path('api/v1/translation/', include('apps.translation.urls')),  # Commented out due to httpcore compatibility issue
