...
CHANNELS_ALLOWED_HOSTS = os.getenv(
    'CHANNELS_ALLOWED_HOSTS',
    'localhost,127.0.0.1,prozeal.athenas.co.in'
).split(',')
...
SECURE_SSL_REDIRECT = False  # os.getenv('SECURE_SSL_REDIRECT', 'True').lower() in ('1', 'true', 'yes', 'on')
...
INSTALLED_APPS = [
    ...
    'control_plane',  # Global control plane for tenants/collaboration
]
...
CONTROL_DB_NAME = _env('CONTROL_DB_NAME', 'athens_control_plane')
CONTROL_DB_USER = _env('CONTROL_DB_USER', PG_DB_USER)
...
AUTHENTICATION_BACKENDS = [
    ...
    # 'authentication.backends.SAPIntegratedAuthBackend',  # Temporarily disabled
]
...
# Remove CORS_ALLOW_ALL_ORIGINS = True - conflicts with CORS_ALLOW_CREDENTIALS = True
# When credentials are included, Access-Control-Allow-Origin cannot be "*"
# Must use specific origins in CORS_ALLOWED_ORIGINS instead
...
# SAP API Configuration for credential synchronization
SAP_API_URL = os.getenv('SAP_API_URL')
SAP_API_KEY = os.getenv('SAP_API_KEY')
SAP_CLIENT_ID = os.getenv('SAP_CLIENT_ID')

# SAP Sync Settings
SAP_SYNC_ENABLED = os.getenv('SAP_SYNC_ENABLED', 'False').lower() in ('true', '1', 'yes')
SAP_SYNC_INTERVAL = int(os.getenv('SAP_SYNC_INTERVAL', '3600'))  # 1 hour default
...
# Don't override the earlier ALLOWED_HOSTS setting
